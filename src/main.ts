...
import { ExampleView, VIEW_TYPE_EXAMPLE } from "./examples/components/ExampleView";
import { Svelte5FeaturesView, VIEW_TYPE_SVELTE5_FEATURES } from "./examples/components/Svelte5FeaturesView";
